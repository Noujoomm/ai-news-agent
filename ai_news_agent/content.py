...
# ---------------------------------------------------------------------------
# 🔥 هوكات مخصّصة لأخبار الأدوات والإطلاقات (أعلى انتشار على تيك توك)
# ---------------------------------------------------------------------------
TOOL_HOOKS = [
    "أداة جديدة نزلت اليوم وبتوفر عليك ساعات… خلني أوريك 👇",
    "لا تدفع لأي أداة قبل ما تشوف هذي — طلعت اليوم وهي ببلاش!",
    "هذي الأداة تسوي في ٣٠ ثانية اللي كان ياخذ منك يوم كامل 🤯",
    "وقّف… الشي اللي نزل اليوم يغيّر طريقة شغلك بالكامل",
    "جربت الأداة الجديدة هذي، وصدق أقولك: ما توقعت النتيجة",
    "ثلاث ثواني بس وبوريك أداة AI جديدة لازم تعرفها",
    "طلعت ميزة جديدة اليوم… وأغلب الناس ما تدري عنها",
    "لو تشتغل على الكمبيوتر يوميًا، هذي الأداة بتغيّر لك اليوم كله",
]


def pick_hook(is_tool_news: bool = False) -> str:
    """يختار هوك مناسب — أخبار الأدوات لها هوكات أقوى."""
    return random.choice(TOOL_HOOKS if is_tool_news else HOOKS)
